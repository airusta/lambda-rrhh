...
@section ('contenido')
    ...
    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
        <h3>Empleados Registrados en Talento Humano</h3>
<!--        <h3>Empleados Registrados en Talento Humano<a href="empleado/create"><button class="btn btn-success">Nuevo</button></a></h3>-->
